...
f <- paste0(wd,"NEON_D19_BONA_DP3_473000_7233000_reflectance.h5")
...
for (i in 1:426){
  #extract one band
  b <- h5read(f,"/BONA/Reflectance/Reflectance_Data",index=list(i,1:nCols,1:nRows)) 
