...
#not sure what numbers to use for z filter
#ABBY <- readLAS(paste0(wd,"NEON_D16_ABBY_DP1_550000_5073000_classified_point_cloud_colorized.laz"))

ABBY <- readLAS(paste0(wd,"NEON_D16_ABBY_DP1_550000_5073000_classified_point_cloud_colorized.laz"),
                filter = "-drop_z_below 126 -drop_z_above 629")
summary(ABBY)
...
combined_results=rbind(HARV_structural_diversity, 
                       TEAK_structural_diversity,
                       ABBY_structural_diversity)

# Add row names for clarity
row.names(combined_results)=c("HARV","TEAK","ABBY")
...
combined_results=rbind(HARV_structural_diversity, 
                       TEAK_structural_diversity,
                       ABBY_structural_diversity,
                       NIWO_structural_diversity)

# Add row names for clarity
row.names(combined_results)=c("HARV","TEAK","ABBY","NIWO")
