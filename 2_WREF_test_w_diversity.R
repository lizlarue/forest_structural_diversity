...
cover2W$monthyear <- substr(cover2W$endDate,1,7)

dates <- unique(cover2W$monthyear)
dates
...
f <- paste0(wd,"NEON_D16_WREF_DP3_593000_5077000_reflectance.h5")
...
for (i in 1:426){
  #extract one band
  b <- h5read(f,"/WREF/Reflectance/Reflectance_Data",index=list(i,1:nCols,1:nRows)) 
